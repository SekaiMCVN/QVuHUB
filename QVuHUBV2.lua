...
for i, v in pairs(UILibNames) do
    QVuHUBV2[v] = {}
    QVuHUBV2[v].__index = QVuHUBV2[v]
end

function QVuHUBV2.new(gameName, userId, rank)
...
function QVuHUBV2.Window:setAnimSpeed(val)
    TI = TweenInfo.new(.4 / (val / 100), Enum.EasingStyle.Exponential, Enum.EasingDirection.Out)
end

function QVuHUBV2.Window:Notification(sett)
...
function QVuHUBV2.Window:Prompt(sett)
...
function QVuHUBV2.Window:ChangeCategory(new)
...
function QVuHUBV2.Window:ChangeCategorySelection(name)
...
function QVuHUBV2.Window:Category(name, icon)
    local catFolder = self.MainUI.MainUI.Sidebar.ContentHolder.Cheats.CheatHolder
...
function QVuHUBV2.Category:Button(name, icon)
...
function QVuHUBV2.Button:Section(name, side)
...
function QVuHUBV2.Section:Button(sett, callback)
    local functions = {}
...
function QVuHUBV2.Section:Checkbox(sett, callback)
    local functions = {}
    functions.__index = functions
...
function QVuHUBV2.Section:Toggle(sett, callback)
    local functions = {}
    functions.__index = functions
...
function QVuHUBV2.Section:Textbox(sett, callback)
    local functions = {}
    functions.__index = functions
...
function QVuHUBV2.Section:Keybind(sett, callback)
    local functions = {}
    functions.__index = functions
...
function QVuHUBV2.Section:ColorPicker(sett, callback)
    local functions = {}
    functions.__index = functions
...
function QVuHUBV2.Section:Slider(sett, callback)
    local functions = {}
    functions.__index = functions
...
function QVuHUBV2.Section:Dropdown(sett, callback)
    local functions = {}
    functions.__index = functions
