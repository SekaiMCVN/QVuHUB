        ...
        table.foreach(
            ...
            function(a, b)
                if QVuHUBLib.Flags[a] then
                    ...
                    warn("Trình tải cấu hình thư viện QVuHUB - Không tìm thấy ", a, b)
                end
            end
        )
    end
        ...
        function TabFunction:MakeTab(TabConfig)
                            ...
                            TweenService:Create(
                                ...
                                TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
                                {
                                    BackgroundColor3 = Color3.fromRGB(
                                        QVuHUBLib.Themes[QVuHUBLib.SelectedTheme].Second.R * 255 + 3,
                                        QVuHUBLib.Themes[QVuHUBLib.SelectedTheme].Second.G * 255 + 3,
                                        QVuHUBLib.Themes[QVuHUBLib.SelectedTheme].Second.B * 255 + 3
                                    )
                                }
                            ):Play()
                        end
                    ...
                    AddConnection(
                        ...
                        function()
                            TweenService:Create(
                                ButtonFrame,
                                TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
                                {BackgroundColor3 = QVuHUBLib.Themes[QVuHUBLib.SelectedTheme].Second}
                            ):Play()
                        end
                    )
                    ...
                    AddConnection(
                        ...
                        function()
                            TweenService:Create(
                                ...
                                {
                                    BackgroundColor3 = Color3.fromRGB(
                                        QVuHUBLib.Themes[QVuHUBLib.SelectedTheme].Second.R * 255 + 6,
                                        QVuHUBLib.Themes[QVuHUBLib.SelectedTheme].Second.G * 255 + 6,
                                        QVuHUBLib.Themes[QVuHUBLib.SelectedTheme].Second.B * 255 + 6
                                    )
                                }
                            ):Play()
                        end
                ...
                function ElementFunction:AddToggle(ToggleConfig)
                    ...
                    function Toggle:Set(Value)
                        ...
                        TweenService:Create(
                            ...
                            {BackgroundColor3 = Toggle.Value and ToggleConfig.Color or QVuHUBLib.Themes.Default.Divider}
                        ):Play()
                        TweenService:Create(
                            ToggleBox.Stroke,
                            TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
                            {Color = Toggle.Value and ToggleConfig.Color or QVuHUBLib.Themes.Default.Stroke}
                        ):Play()
                        TweenService:Create(
                            ToggleBox.Ico,
                            TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
            ...
            function ElementFunction:AddSection(SectionConfig)
                ...
                AddConnection(
                    ...
                    function()
                        SectionFrame.Size =
                            UDim2.new(1, 0, 0, SectionFrame.Holder.UIListLayout.AbsoluteContentSize.Y + 31)
            ...
            if TabConfig.PremiumOnly then
                ...
                SetChildren(
                    ...
                    ),
                    {
                        ...
                        AddThemeObject(
                            SetProps(
                                MakeElement("Label", "Truy cập trái phép", 14),
                                {
                        ...
                        AddThemeObject(
                            SetProps(
                                MakeElement("Label", "Chức năng Premium", 14),
                                {
                        ...
                        AddThemeObject(
                            SetProps(
                                MakeElement(
                                    "Label",
                                    "Phần này của script chỉ dành cho người dùng QVuHUB Premium. Hãy mua Premium trong https://sekairealm.blogspot.com/p/qvuhub-lua-roblox.html.",
                                    12
                                ),
                                {
        ...
        QVuHUBLib:MakeNotification(
            {
                ...
                Content = "Thư viện UI mới có sẵn tại https://sekairealm.blogspot.com/p/qvuhub-lua-roblox.html",
                Time = 5
            }
        )
